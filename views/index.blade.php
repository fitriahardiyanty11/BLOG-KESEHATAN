...
<div class="container">
      <div class="col-sm">
        <div class="card" style="width: 80%;">
            <img src="https://2.bp.blogspot.com/-aaAp8-kAwuM/V0qHA4JPVvI/AAAAAAAABs0/AdPyhQsmQSo51tNzaMkeN2MUdo2GjZJNgCLcB/s1600/tips%2Bolahraga%2Bsaat%2Bpuasa.jpg" class="card-img-top" alt="gambar laptop">
            <div class="card-body">
              <h5 class="card-title">TIPS MENJAGA KESEHATAN TUBUH</h5>
              <p class="card-text"><li> Konsumsi makanan sehat</li>
