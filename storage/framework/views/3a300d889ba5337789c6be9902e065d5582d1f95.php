...
<div class="container">
      <div class="col-sm">
        <div class="card" style="width: 80%;">
            <img src="https://cdn.slidesharecdn.com/ss_thumbnails/tipsdietsehatnutrishake-150215091848-conversion-gate01-thumbnail-4.jpg?cb=1423991978" class="card-img-top" alt="gambar laptop">
            <div class="card-body">
              <h5 class="card-title">TIPS DIET SEHAT</h5>
              <p class="card-text"><li>Makan secara perlahan</li>
...
Orang yang tercukupi asupan air minumnya terbukti mengonsumsi 200 kalori lebih sedikit per hari.

<li>Rebus makanan daripada digoreng</li>
...
<li>Konsumsi omega-3 dan vitamin D</li>
...
<li>Masak di rumah lebih sering</li>
...
<li>Lebih aktif ketika diet sehat</li>
...
<li>Makanlah buah dibanding meminumnya</li>
...
<li>Dapatkan waktu tidur yang cukup</li>
...
Terlebih lagi, kurang tidur bisa meningkatkan risiko beberapa penyakit, seperti penyakit radang dan penyakit jantung. Karena itu, sangat penting untuk mendapatkan tidur berkualitas baik yang memadai terutama ketika menjalani diet. 
</p>
            </div>
          </div>
      </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog-kesehatan\resources\views/diet.blade.php ENDPATH**/ ?>