...
<div class="container">
      <div class="col-sm">
        <div class="card" style="width: 80%;">
            <img src="https://1.bp.blogspot.com/-ZPOZ43s1iIM/YIT_BGV4lYI/AAAAAAAACP0/JVs_SKacetogm5Pk3PsCPBqVm8vHpf32QCLcBGAsYHQ/s673/042112000_1613641238-Cara-Menjaga-Kesehatan-Mental-Remaja_di-Masa-Pandemi-COVID-19-by-undefined-undefined-Canva.jpg" class="card-img-top" alt="gambar laptop">
            <div class="card-body">
              <h5 class="card-title">TIPS MENJAGA KESEHATAN MENTAL</h5>
              <p class="card-text"><li>Katakan Hal Positif pada Diri Sendiri</li>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog-kesehatan\resources\views/mental.blade.php ENDPATH**/ ?>